...
try:
    from settings import POSTGRESQL_DB_PORT, POSTGRESQL_DB_NAME, POSTGRESQL_DB_USER, POSTGRESQL_DB_PASSWORD, POSTGRESQL_DB_HOST
...
class PostgresConfiguration():
    ...
    print(f'host => {POSTGRESQL_DB_HOST}, \ndb_name => {POSTGRESQL_DB_NAME}')
    @property
    ...
    try:
        ...
        for el in res:
            ...
            with PostgresConfiguration().pg2 as con:
                ...
                cur.execute(count)
                cnt = cur.fetchall()
                cnt_for_layer = int(cnt[0][0])
                el['count'] = cnt_for_layer
